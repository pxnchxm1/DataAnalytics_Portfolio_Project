...
alter table nashvilleHousing add OwnerAddress1 nvarchar(255) ,
  OwnerCity nvarchar(255),OwnerState nvarchar(255);
...
select * from nashvilleHousing;
alter table nashvilleHousing drop column TaxDistrict,PropertyAddress;